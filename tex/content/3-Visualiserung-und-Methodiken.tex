...
Aber auch aus Gründen der Robustheit sind transparente Abhängigkeiten wichtig. Wenn Abhängigkeiten weitere Abhängigkeiten in das System einbringen, entstehen schnell größere Kaskaden. Ändern sich zentrale Komponenten in diesen Abhängigkeitskaskaden, kann dies dazu führen, dass große Teile des Abhängigkeitsgeflecht, sich mit anpassen müssen.
...
\paragraph{Liniendiagramm}

zeitlicher verlauf

\paragraph{Balkendiagramm}

Sortierte vergleichenden Metriken
