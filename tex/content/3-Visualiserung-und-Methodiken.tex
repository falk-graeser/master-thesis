...
Das Konfigurationsmanagement aus der automatisierten Softwareerstellung kann auch für eine System- und Konfigurationsübersicht verwendet werden. Es lassen sich alle bekannten Umgebungsvarianten abbilden. Zusammen mit einer Liste von Systemen, die aktuell verwendet werden, lässt sich somit darstellen, welche Systeme, in welcher Konfiguration und welchem Softwarestand aktuell verfügbar sind. Sind die Systeme zusätzlich in einer Build-Pipeline verbunden, kann dies ebenfalls dargestellt werden.

- explorativ tests auf bestehenden systemen
- system pool management
- übersicht von virtualiserten / container systemen
- build pipe-line übersicht
- steuerung von verteilten systemen
- übersicht von system landschaften 

- übersicht von datenbank-ständen?
- ermutigung von vereinheitlichung von systemkonfigurationen (einfache system übersicht / kategoriesierung)
