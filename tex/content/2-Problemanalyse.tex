...
vielen Packetverwaltungen diese Informationen in einer Lock-Datei festgehalten. Es wird zudem angeraten, diese Datei in die Versionkontrolle aufzunehmen.\footcite[vgl.][]{composer-why-lock-in-vcs} Das Festhalten der exakten Versionsnummern der verwendeten Abhängigkeiten ist ein deutlicher Vorteil. Dadurch ist möglich immer wieder zu dem in der Version gesicherten Zustand der Softwareanwendung zurückzukehren. Ohne dies wären die Abhängigkeiten der Anwendung variabel.

In Abbildung \ref{dependency-mgmg-composer-wikia} ist ein Ausschnitt einer composer.json und der zugehörigen Lock-Datei zu sehen. Beide Dateien sind im JSON-Format und nutzen jeweils eine DSL für die Packetverwaltung Composer\footcite{composer-json}. In der Abbildung wird die Verwendung von regulären Ausdrücken in Verbindung mit einem Paketnamen dargestellt. Zudem wird die Präzisierung der Paketdatei zur Lock-Datei deutlich.
